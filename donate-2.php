...
<html lang="en-US">
	<head>
		...
		<!-- favicon -->
		<link rel="icon" href="favicon.png" sizes="18x16" type="image/png"> 
	</head>
	...
	<body>
		...
		<div class="wrapper offcanvas-container" id="offcanvas-container">
			<!-- inner-wrapper -->
								...
								<nav class="navbar navbar-default main-nav" role="navigation">
										...
										<div class="collapse navbar-collapse">
											<ul class="nav navbar-nav navbar-right">
												...
												<li class="dropdown" ><a href="services.html">Exam Papers PDF<b class="caret"></b></a>
																							<!-- submenu-wrapper -->
													<div class="submenu-wrapper submenu-wrapper-topbottom">
														<div class="submenu-inner  submenu-inner-topbottom">
															<ul class="dropdown-menu">
																<li><a href="blog.html">SPU COURSES</a></li>
																<li><a href="blog-timeline.html">ITC COURSES</a></li>
																<li><a href="blog-masonry.html">IELTS COURSES</a></li>
												...
												<li class="dropdown"><a href="index.html" >Courses PDF<b class="caret"></b></a>
													<!-- submenu-wrapper -->
													<div class="submenu-wrapper submenu-wrapper-topbottom">
														<div class="submenu-inner  submenu-inner-topbottom">
															<ul class="dropdown-menu">
																<li><a href="blog.html">IT</a></li>
																<li><a href="blog-timeline.html">Science</a></li>
																<li><a href="blog-masonry.html">Commerce</a></li>
																<li><a href="blog-single.html">Single Article</a></li>
															</ul>
														</div>
													</div> <!-- /submenu-wrapper -->
												...
												<span class="support-btn pull-right"> <a href="#">Donet Material</a></span>
											</ul>
										</div><!-- /navbar-collapse -->
									</nav>
								...
								<div class="get-in-touch brand-bg clearfix">
									...
									<div class="col-md-6 col-sm-4">
										<div class="social-icon pull-right">
											<ul>
												<li><a href="https://github.com/TotalDataSolution/study_solution"><i class="fa fa-github"></i></a></li>
 			 ...
 			 <address>
 					 ...
 					 Information Techonology Center,Mogri<br>
 			 </address>
 						 </div>
						</div>
			...
			<section class="contact-wrapper">
				...
				<div class="container-fluid">
					<div class="section-title">
						...
						<p>We Will Touch in Any Time</p>
					</div>

					<div class="row">
				        <div class="col-md-7">
				            <form id="contactForm" action="sendemail.php" method="POST"  role="form">
								...
								<div class="row contact-address">
									...
									<div class="col-md-7">
										<address>
										  ...
										  <i>Time </i> -24/6  10AM to 3 PM<br>
										</address>

										<br>

										<address>
										  <i>work with us</i> - <a href="mailto:hari@digihost.ga">hari@digihost.ga</a><br>

										  <i>join our team</i> - <a href="mailto:krishna@digihost.ga">krishna@digihost.ga</a><br>
		...
		<div class="offcanvas-menu offcanvas-effect">
			...
			<h2>Total<br>Study Solution</h2>
			<ul>
				<li><a href="#"><i class="fa fa-angle-down"></i>Home</a></li>
				<li><a href="#"><i class="fa fa-angle-down"></i>Exam Papers</a>
					<ul>
				<li><a href="about.html">SPU Papers</a></li>
						<li><a href="services.html"></i> ITC Papers</a></li>
						<li><a href="404.html">IELTS Tests</a></li>
					</ul>
				</li>
				<li><a href="#"><i class="fa fa-angle-down"></i>Materials</a>
					<ul>
						<li><a href="about.html"> SPU COURSES</a></li>
				<li><a href="about.html"> ITC COURSES</a></li>
			<li><a href="about.html"> IELTS COURSES</a></li>

			</ul>
				</li>

				<li><a href="#"><i class="fa fa-angle-down"></i>Other</a>
					<ul>
						<li><a href="contact2.html">About Us</a></li>
						<li><a href="contact.html">Contact Us</a></li>
						<li><a href="contact2.html">Feedback</a></li>
					</ul>
				</li>
			</ul>
		</div><!-- .offcanvas-menu -->
